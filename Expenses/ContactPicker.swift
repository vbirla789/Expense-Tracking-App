...
/// Apple's native multi-select contact picker, presented imperatively from a
/// hidden host so dismissing it never dismisses the capture sheet behind it.
/// Needs NO contacts permission — the system picker returns only who you tick.
